...
def visualize():
    ...
    joint2 = sphere(pos = (link1.axis + link1.pos), color = vector(0,0,255))
    link2 = cylinder(pos = (link1.axis + link1.pos), axis = vector(0, linklength, 0))
    ...
    c = cylinder(pos = vector(-20, 10, 13), axis = vector(10, 0, 0))
    return link1, link2, link3, c
